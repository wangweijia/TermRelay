...
export class ClientAuth1789696800000 implements MigrationInterface {
  name = 'ClientAuth1789696800000';

  async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`CREATE TABLE client_pairings (
      id CHAR(36) NOT NULL,
  ...
  async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query('DROP TABLE IF EXISTS client_pairings');
  }
}